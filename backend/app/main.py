...
from .routes import auth, financial_summary, transactions, investments, tax, forecasting, recommendations, report_routes
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Temporarily allow all origins for local development
